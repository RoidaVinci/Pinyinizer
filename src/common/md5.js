// Minimal MD5 (RFC 1321) for API request signing (e.g. Baidu Fanyi).
// WebCrypto does not expose MD5, so we ship this ~60-line implementation.
// Input: string (UTF-8 encoded internally). Output: lowercase hex digest.
